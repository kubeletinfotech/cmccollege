                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-6 mt-8 max-w-5xl mx-auto auto-rows-[160px] sm:auto-rows-[200px] md:auto-rows-[260px]">
                    {GALLERY_IMAGES.map((imgSrc, idx) => (
                        ...
                        >
                            ...
                            />
                            <div className="absolute inset-0 bg-linear-to-t from-[#003366]/60 via-[#003366]/0 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                            {idx === 0 && (
                                <div className="absolute bottom-6 left-6 right-6 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-4 group-hover:translate-y-0">
                                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/30 backdrop-blur-md rounded-full text-white font-medium text-sm border border-white/40 tracking-wide shadow-xl">
                                        <Award size={16} className="text-amber-300" /> Key Highlight
                                    </div>
                                </div>
                            )}
                        </motion.div>
