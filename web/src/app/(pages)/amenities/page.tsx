...
// Variants removed as per request to disable entry animations

export default function AmenitiesPage() {
    return (
        <div className="min-h-screen bg-[#FDFCFB] text-zinc-900 pt-[112px]">
            {/* --- Hero Section --- */}
            <section className="relative py-24 px-6 bg-linear-to-b from-[#5D1035] to-[#3d0a23] text-white overflow-hidden">
                    ...
                    {amenitiesList.map((item) => (
                        ...
                        >
                            <Link href={`/amenities/${item.slug}`} className="block h-full w-full relative">
                                ...
                                <div className="absolute inset-0 bg-linear-to-t from-black/60 to-transparent group-hover:from-black/40 transition-colors duration-500" />
