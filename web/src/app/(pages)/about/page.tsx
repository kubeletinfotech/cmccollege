                ...
                <div className="flex flex-col gap-12 lg:gap-16">
                    ...
                    >
                        <Image
                            ...
                            width={1200}
                            height={600}
                            className="w-full h-auto rounded-xl md:rounded-md shadow-2xl hover:scale-105 transition-transform duration-700"
                            priority
                        />
                    </motion.div>
                    ...
                    >
                        <h1 className="text-4xl md:text-5xl font-serif font-bold text-emerald-900 leading-tight">
                            A Legacy of <br className="md:hidden" />
                            <span className="text-emerald-700">Academic Excellence</span>
                        </h1>
                        <p className="text-lg text-zinc-600 leading-relaxed font-light text-left md:text-center lg:text-justify hyphens-auto mt-6">
                        ...
                        <p className="text-lg text-zinc-600 leading-relaxed font-light text-left md:text-center lg:text-justify hyphens-auto">
            ...
            <section className="bg-zinc-50 py-16 md:py-20">
                <div className="container mx-auto px-4">
                    <div className="flex flex-col gap-12">
                        ...
                        >
                            <Image
                                src="https://ik.imagekit.io/1yxtj9qun/About/college-image-1.jpeg?updatedAt=1770370502054"
                                alt="Institutional Overview"
                                width={1200}
                                height={600}
                                className="w-full h-auto rounded-xl md:rounded-md shadow-xl hover:scale-105 transition-transform duration-700"
                            />
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="pt-8 flex justify-center">
                                <blockquote className="border-l-4 border-emerald-600 pl-6 italic text-zinc-700 text-lg md:text-xl font-serif max-w-2xl text-left">
