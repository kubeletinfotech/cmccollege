        ...
        <div className="flex min-h-screen flex-col bg-white text-zinc-900 font-sans pt-20">
            ...
            <section className="py-24 px-6 max-w-5xl mx-auto">
                <ScrollReveal>
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-emerald-800 mb-8">Who We Are</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-stretch">
                        ...
                        <ScrollReveal className="flex flex-col">
                            <div className="relative h-64 rounded-2xl overflow-hidden shadow-xl mb-8">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center">
                                    <h3 className="text-3xl font-bold text-white uppercase tracking-widest">Our Vision</h3>
                                </div>
                            </div>
                        ...
                        <ScrollReveal delay={200} className="flex flex-col">
                            <div className="relative h-64 rounded-2xl overflow-hidden shadow-xl mb-8">
                                ...
                                <div className="absolute inset-0 bg-emerald-900/40" />
                                <div className="absolute inset-0 flex items-center justify-center">
                                    <h3 className="text-3xl font-bold text-white uppercase tracking-widest">Our Mission</h3>
                                </div>
                            </div>
                            <div className="bg-white p-8 rounded-2xl border border-emerald-50 shadow-sm flex-grow">
            ...
            <section className="py-24 px-6 max-w-7xl mx-auto">
                <ScrollReveal className="text-center mb-16">
                    ...
                    <p className="text-zinc-600 text-lg">Commitment to excellence in every aspect of student life.</p>
                </ScrollReveal>
                        ...
                        <div className="md:col-span-7">
                            <ScrollReveal>
                                <div className="relative">
                                    ...
                                    <h2 className="text-3xl font-bold text-emerald-800 mb-8 relative z-10">Principal's Message</h2>
                                    <div className="space-y-6 text-lg text-zinc-700 leading-relaxed italic relative z-10">
                                        ...
                                        <div className="mt-10">
                                            <p className="font-bold text-emerald-900 not-italic">Mrs. Sarah Johnson</p>
                                            <p className="text-zinc-500 not-italic">Principal, Integrated School</p>
                                        </div>
                                    </div>
                                </div>
                            </ScrollReveal>
            ...
            <section className="py-20 px-6 bg-emerald-900 text-white text-center">
                <ScrollReveal className="max-w-4xl mx-auto">
                    ...
                    <p className="text-emerald-100 text-lg mb-10">Discover a place where academic dreams meet moral values.</p>
