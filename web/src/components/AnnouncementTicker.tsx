            ...
            >
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        >
                            <span className="text-emerald-50 text-xs font-semibold truncate max-w-[60vw] md:max-w-none">
                                {currentAnnouncement.title}
                            </span>
                            <span className="text-emerald-400 text-[10px] font-bold uppercase tracking-widest hover:underline flex items-center gap-1.5 flex-shrink-0">
                                Click Here
