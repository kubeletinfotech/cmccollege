...
export default function Footer() {
    ...
    return (
        <footer className="bg-[#7B0046] text-white py-16 px-6 md:px-12">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-16">
                ...
                <div className="flex flex-col items-start md:items-center lg:items-start text-left md:text-center lg:text-left md:col-span-2 lg:col-span-1">
                    ...
                    <div className="flex gap-4 md:justify-center lg:justify-start w-full">
                        <a href="https://www.facebook.com/cmcwayanad" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-emerald-700/50 hover:border-emerald-500/50 transition-all hover:-translate-y-1" aria-label="Visit our Facebook page">
                        ...
                        <a href="https://www.instagram.com/cmcollege_nadavayal" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-emerald-700/50 hover:border-emerald-500/50 transition-all hover:-translate-y-1" aria-label="Visit our Instagram page">
                        ...
                        <a href="https://www.youtube.com/@CMCollegeofArtsandScience" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-emerald-700/50 hover:border-emerald-500/50 transition-all hover:-translate-y-1" aria-label="Visit our YouTube channel">
                    ...
                    <ul className="space-y-5 text-white/90">
                        ...
                        <li className="flex gap-4 items-center">
                            ...
                            <div className="flex flex-col normal-case">
                                ...
                                <span className="text-[11px] text-white/60 uppercase tracking-wider font-bold">Office Line</span>
                            </div>
                        </li>
                        <li className="flex gap-4 items-start">
                            <div className="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center shrink-0 border border-white/20">
            ...
            <div className="max-w-7xl mx-auto mt-10 pt-8 border-t border-white/10 text-center text-sm text-emerald-100/80">
