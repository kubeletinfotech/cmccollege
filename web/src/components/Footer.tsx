            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-16">
                ...
                <div className="flex flex-col items-center text-center md:col-span-2 lg:col-span-1">
                    ...
                    <div className="flex gap-4 md:justify-center lg:justify-start w-full">
                        ...
                        <a href="https://www.instagram.com/cm_college_official" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-emerald-700/50 hover:border-emerald-500/50 transition-all hover:-translate-y-1" aria-label="Visit our Instagram page">
                ...
                <div className="flex flex-col items-start text-left">
                    ...
                    <ul className="space-y-3 text-white/90">
                        ...
                        <li>
                            <Link href="/about/administration" className="hover:text-emerald-300 transition-colors inline-block py-0.5">
